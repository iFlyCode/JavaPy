...
public class Sequences {
	...
	/**
	 * Takes an imaginary number, and returns whether or not it is bounded under 2
	 * after a certain number of iterations, by the equation z = z^2 + (second given imaginary number)
	 * 
	 * @author ncolaprete
	 * @param real - Real part of the number to check if bounded
	 * @param imag - Imaginary part of the number to check if bounded
	 * @param cReal - Real part of the julia set to check in
	 * @param cImag - Imaginary part of the julia set to check in
	 * @param iters - Number of iterations to check if the number is bounded
	 * @return number of iterations before the number became unbounded,
	 *             - or returns the number of iterations given if is bounded
	 */
	public int julia(double real, double imag, double cReal, double cImag, int iters) {
		int to_sender = 0;
	...
	/**
	 * Takes an imaginary number, and returns whether or not it is bounded under 2
	 * after a certain number of iterations, by the equation z = z^2 + c
	 * 
	 * @author ncolaprete
	 * @param real - Real part of the number to check if bounded
	 * @param imag - Imaginary part of the number to check if bounded
